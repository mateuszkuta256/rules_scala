...
#$runner test_scala_library_expect_failure_on_missing_direct_external_deps_jar TODO #1482
#$runner test_scala_library_expect_failure_on_missing_direct_external_deps_file_group TODO #1482
...
#$runner test_scala_library_expect_better_failure_message_on_missing_transitive_dependency_labels_from_other_jvm_rules TODO #1482
